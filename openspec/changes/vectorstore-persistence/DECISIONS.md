...
```yaml
decisions:
  upload_strategy: "B"  # A/B/C/D
  failure_handling: "A+B"  # A/B/C/D 或組合
  manual_rebuild_api: "yes"  # yes/no
  storage_location: "./vectorstore/"  # 路徑
  
implementation_plan: "MVP"  # MVP/Enhanced
